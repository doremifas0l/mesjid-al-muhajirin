...
import ArticleCard, { type ArticleCardInput } from './article-card'

// Type definitions for events and page content
type DbEvent = {
  id: string
  title: string
  starts_at: string
...
export default function HomeContent() {
  // State for events, articles, dynamic content, and hero images
  ...
  useEffect(() => {
    ;(async () => {
      ...
      if (eRes.ok) {
       ...
       // Fetch articles (limit to 6 for the grid)
      const aRes = await fetch("/api/articles?limit=6");
      if (aRes.ok) {
  ...
  // Memoized logic to filter and sort upcoming events
  ...
  // Helper function to map event data for the card component
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* 2. ABOUT (TENTANG) & CHATBOT SECTION */}
      <section id="chat" className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
